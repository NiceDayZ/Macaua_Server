...
public class Main extends Application {
    ...
    private void setup() {
        ...
        mStart.addEventFilter(MouseEvent.MOUSE_CLICKED, e -> {
            ...
            System.out.println("atatea carti is"+packOfCards.getListOfCards().size());
            System.out.println("atatea carti imi da" + packOfCards.getListOfAvaibleCards().size());
        ...
        new Thread(new startServer(2000)).start();
